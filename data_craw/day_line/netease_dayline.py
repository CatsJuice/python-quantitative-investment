...
class NetEaseDayLine(object):
    ...
    def __init__(self, stock_list_file, save_path_prefix, end_date='99999999', thread_num=1, timeout=10):
        self.stock_list_file = stock_list_file          # 全部股票信息的csv文件
        self.save_path_prefix = save_path_prefix        # 日线存储文件夹目录
        self.end_date = end_date                        # 截至日期
...
if __name__ == "__main__":
    ...
    stock_list_file = consts['stock_list_file']                      # 全部股票信息的csv文件
    save_path_prefix = consts['day_line_file_prefix']                # 日线存储文件夹目录
